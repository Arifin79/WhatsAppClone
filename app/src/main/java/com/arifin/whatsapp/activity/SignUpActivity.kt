...
import com.arifin.whatsapp.util.User
            ...
            firebaseAuth.createUserWithEmailAndPassword(
                ...
                .addOnCompleteListener { task ->
                    if (!task.isSuccessful) {
                        ...
                        val email = edt_email.text.toString() //mengubah text yg di EditText jadi String
                        val phone = edt_phone.text.toString()
                        val name = edt_name.text.toString()
                        val user = User(email,phone,name, "","Hello i'am new","","")
                        firebaseDb.collection(DATA_USERS) //mengakses database tabel User
